...
OUTPUT_REPO = "P2SAMAPA/p2-etf-conformal-prediction-distributional-results"
...
# Conformal distributional parameters
N_QUANTILES = 19             # number of quantiles for predictive distribution
N_ESTIMATORS = 50
MAX_DEPTH = 5
TOP_N = 3
